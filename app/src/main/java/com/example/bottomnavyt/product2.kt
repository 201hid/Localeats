...
//
//class product2 : Fragment() {
//
//    private val productData = Product("Toyota Camry", 2f, listOf("Sleek Comfort, Driven by Excellence."), 50.0)
...
//
//        productImageView.setImageResource(R.drawable.camry)  // <-- Set your image here
//
//
