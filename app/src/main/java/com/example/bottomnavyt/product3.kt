...
//
//class product3 : Fragment() {
//
//    private val productData = Product("Toyota Prius", 2f, listOf("Drive Green, Embrace Tomorrow."), 50.0)
...
//
//        productImageView.setImageResource(R.drawable.prius)  // <-- Set your image here
//
//
